...
class IdealSolution extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('idealsolution', compact('co_admin','idealSolutions', 'criteriaweights'));
    }
    public function view()
    {
        ...
        // $nama = $mahasiswa->nama;
        $periode = Periode::all();
        return view('idealsolution_view', compact('co_admin','periode','mahasiswa','userId'));
    }
}
