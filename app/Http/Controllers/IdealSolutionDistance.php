...
class IdealSolutionDistance extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('idealsolutiondistance', compact('co_admin','distances', 'criteriaweights'))->with('i', 0);
    }
    public function view()
    {
        ...
        // $nama = $mahasiswa->nama;
        $periode = Periode::all();
        return view('idealsolutiondistance_view', compact('co_admin','periode','mahasiswa','userId'));
    }
}
